"""
Django settings for LaDespensa project.
...
SECRET_KEY = 'django-insecure-l!gu5r_5q*o*3g@0x)c#b3^79&x9kukm_h(l8c-*x-b2ncc^t$'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'supermercado.context_processors.usuario_context',
                'supermercado.context_processors.carrito_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'LaDespensa.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / "supermercado" / "estatico",
]
